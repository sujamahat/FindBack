  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-2 rounded-xl border border-dashed border-brand-line bg-surface p-4">
        ...
        {geoStatus === "loading" && <p className="text-xs text-ink-soft">위치 확인 중...</p>}
      ...
      <div className="flex flex-col gap-2">
        <label className="text-sm font-semibold text-ink">발견 장소 또는 건물 (선택)</label>
      ...
      <fieldset className="flex flex-col gap-2">
        <legend className="mb-1 text-sm font-semibold text-ink">물건을 어떻게 하셨나요?</legend>
        ...
        {fieldErrors.returnMethod && (
          <span className="text-xs font-semibold text-rose-700">{fieldErrors.returnMethod}</span>
        )}
      </fieldset>
      ...
      <div className="flex flex-col gap-2">
        <label className="text-sm font-semibold text-ink">전하고 싶은 말 (선택)</label>
        <div className="flex flex-wrap gap-2">
      ...
      <label className="flex items-start gap-3 rounded-xl border border-brand-line bg-brand-soft p-4 text-sm text-ink">
        <input type="checkbox" name="privacyAck" required className="mt-1 h-4 w-4 accent-brand" />
        <span>
      ...
      {fieldErrors.privacyAck && (
        <span className="-mt-3 text-xs font-semibold text-rose-700">{fieldErrors.privacyAck}</span>
      )}
      ...
      <button
        ...
        className="rounded-[24px] bg-brand px-6 py-4 text-base font-bold text-white shadow-sm shadow-brand/30 transition hover:bg-brand-deep active:scale-[0.98] disabled:opacity-60"
      >
