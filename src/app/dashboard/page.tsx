...
const DEMO_ITEMS: DashboardItem[] = [
  { id: "demo-1", name: "에어팟 프로 2", category: "전자기기", status: "safe", photoUrl: null, description: null, publicToken: "demo0000", rewardAmount: null, reportCount: 0 },
  { id: "demo-2", name: "자동차 키 (제네시스)", category: "열쇠", status: "lost", photoUrl: null, description: "검정 가죽 키홀더", publicToken: "demo0001", rewardAmount: 30000, reportCount: 2 },
  { id: "demo-3", name: "하늘색 우산", category: "우산", status: "returned", photoUrl: null, description: null, publicToken: "demo0000", rewardAmount: null, reportCount: 1 },
];
...
export default async function DashboardPage() {
  ...
  const { data: items } = await supabase
    .from("items")
    .select("id, name, category, description, status, photo_url, public_token, reward_amount, found_reports(count)")
